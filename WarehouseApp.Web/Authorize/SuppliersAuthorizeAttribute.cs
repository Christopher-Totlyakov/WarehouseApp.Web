...
{
	public class SuppliersAuthorizeAttribute : AuthorizeAttribute, IAuthorizationFilter
	{
		public void OnAuthorization(AuthorizationFilterContext context)
		{
			...
			var isWarehouseWorker = repository.GetAllAttached<Supplier>().Any(w => w.Id == userId);
