...
{
    public class SenderMessageUserAuthorizeAttribute : AuthorizeAttribute, IAuthorizationFilter
    {
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            var isWarehouseWorker = repository.GetAllAttached<SenderMessageUser>().Any(w => w.Id == userId);
