        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RequestedByWorkerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcessedByWorkerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ProcessedByWorkerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "MessagesForWarehouseWorkers",
                columns: table => new
                {
                    WarehouseWorkerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MassageId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessagesForWarehouseWorkers", x => new { x.WarehouseWorkerId, x.MassageId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_MessagesForWarehouseWorkers_Messages_MassageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceUponRequest = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestProducts", x => new { x.ProductId, x.RequestId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessagesForWarehouseWorkers_MassageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_RequestedByWorkerId",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_ProcessedByWorkerId",
                table: "Requests",
